...
$(function(){
	$('#writeBtn').click(function(){
		$('#nameDiv').empty(); //document.getElementById("nameDiv").innerText=""; 이거랑 같은거임
		$('#idDiv').empty(); //document.getElementById("idDiv").innerText=""; 이거랑 같은거임
		$('#pwdDiv').empty(); //document.getElementById("pwdDiv").innerText=""; 이거랑 같은거임
		$('#repwdDiv').empty(); //document.getElementById("repwdDiv").innerText=""; 이거랑 같은거임
		
		//id 속성
		//if($('#name').val() == '') $('#nameDiv').html('이름 입력'); 
		//if(document.writeForm.name.value == "") document.getElementById("nameDiv").innerText="이름을 입력하세요"; 요거랑 같은거임
		
		//name 속성
		if($('input[name="name"]').val() == '') $('#nameDiv').html('이름 입력');
...
function checkId(){
	...
	if(id == "")
		...
		window.open("/memberServlet/CheckIdServlet?id="+id, "checkId", "width=350 height=100 top=200 left=700");
}
